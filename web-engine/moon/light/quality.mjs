...
export const SETTINGS = Object.freeze({
  high: Object.freeze({ pixelRatio: 2, effects: 1, shadowMapSize: 2048, shadowRadius: 5, bloom: true, bloomScale: 0.5, lights: POOL_SIZE.high, tiltShift: true, leaves: 64, insects: 3, birds: 5, water: 1, smoke: 48, embers: 32, splash: 48 }),
